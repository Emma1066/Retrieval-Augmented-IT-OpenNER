...
exp_name=skyner_${subset}_RA_IT_rand
...
# out-domain example, random
data_path=data/benchmark_it_data_rag/${dataname}/test_w_rand_examp_2_skygpt3.5_5k_random_42.json
category=rand
output_dir=outputs/${modelname}/${finetuning_type}/${stage}/${exp_name}/${category}/${dataname}/
